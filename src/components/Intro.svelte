...
>
	...
	<main class="group/main flex flex-col items-center justify-evenly text-gray-700">
		...
		>
			...
			<nav
				class="font-twoweekend w-full max-w-md rounded-full border border-white/15 bg-black/60 px-3 py-2 text-xs backdrop-blur-lg sm:w-auto sm:max-w-none sm:px-5 sm:py-2.5 sm:text-sm lg:px-6 lg:py-3"
				aria-label="Primary"
			>
